    ...
    <div className="space-y-2 min-w-max max-w-lg">
      ...
      <div className="bg-white dark:bg-[#1D2226] rounded-lg overflow-hidden relative flex flex-col items-center text-center border border-gray-300 dark:border-none">
        <div className="relative w-full h-14">
          <Image src="https://rb.gy/i26zak" alt="img" layout="fill" priority />
        </div>
        ...
        <div className="hidden md:inline text-left dark:text-white/75 text-sm">
          <div className="font-medium sidebarBtn space-y-0.5">
      ...
      {/* Bottom */}
      <div className="hidden md:flex flex-col bg-white dark:bg-[#1D2226] text-black/70 dark:text-white/75 rounded-lg overflow-hidden space-y-2 pt-2.5 sticky top-20 border border-gray-300 dark:border-none">
        ...
        <div className="sidebarBtn text-center">
